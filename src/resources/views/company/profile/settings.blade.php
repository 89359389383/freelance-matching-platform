...
<body>
    ...
    <main class="main-content max-w-3xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-10">
        ...
        @if(session('success'))
            <div class="rounded-lg border p-4 mb-6" style="background-color: #d4edda; color: #155724; border-color: #c3e6cb;">
                {{ session('success') }}
            </div>
        @endif

        @if(session('error'))
            <div class="rounded-lg border p-4 mb-6" style="background-color: #f8d7da; color: #721c24; border-color: #f5c6cb;">
                {{ session('error') }}
            </div>
        @endif
