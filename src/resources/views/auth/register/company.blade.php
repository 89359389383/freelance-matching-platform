...
<head>
    ...
    <title>企業登録（ログイン情報登録） - AITECH</title>
    <style>
        /* リセット & ベース */
        * {
            margin: 0;
...
<body>
    ...
    <div class="container px-4 md:px-6 lg:px-8 py-10">
        <div class="register-card p-6 md:p-10 lg:p-12">
            <div class="page-title text-lg md:text-xl font-black text-center">企業登録（ログイン情報登録）</div>
            ...
            <form class="register-form" method="POST" action="{{ route('auth.register.company.store') }}">
                @csrf
                ...
                <button type="submit" class="register-button">登録して次へ</button>

                <div class="login-link">
                    <a href="{{ route('auth.login.form') }}">すでにアカウントをお持ちの方はこちら</a>
                </div>
            </form>
        </div>
    </div>
